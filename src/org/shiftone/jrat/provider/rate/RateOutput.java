...
import org.shiftone.jrat.provider.rate.ui.RateOutputViewerFactory;
...
public class RateOutput {
    ...
    private static final Log     LOG             = LogFactory.getLogger(RateOutput.class);
    ...
    public synchronized void printHeader(long period) throws IOException {
        ...
        print("viewer=\"");
        print(RateOutputViewerFactory.class.getName());
        println("\"");
        println(maxMethods);
    ...
    /**
     * Flushes the current set of accumulators to file and resets them.
     * This method has side effect on handlers.
     *
     * @param handlers .
     */
