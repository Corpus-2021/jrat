...
public class RateMethodHandlerFactory extends AbstractMethodHandlerFactory {
    ...
    private static final Log     LOG              = LogFactory.getLogger(RateMethodHandlerFactory.class);
    ...
    public void startup(RuntimeContext context) throws Exception {
        ...
        try {
            ...
            outputStream = context.newOutputStream(getOutputFile() + ".jrat", isCompressOutput());
