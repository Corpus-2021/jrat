...
/**
 * Table model that provides a view of the RateModel containing each method.  Allows selection
 * and deselection of methods, which add and remove graphs from the viewer.
 *
...
public class RateModelTableModel extends AbstractTableModel
{
    ...
    private static final Log      LOG               = LogFactory.getLogger(RateModelTableModel.class);
    ...
    public RateModelTableModel(RateModel rateModel)
    {
        ...
        {
            showFlags[i] = Boolean.valueOf(i < CHECKED_AT_START);
        }
    }
