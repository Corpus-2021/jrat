...
public class AccumulatorTestCase extends TestCase {
    ...
    private static final Log    LOG       = LogFactory.getLogger(AccumulatorTestCase.class);
    ...
    public void testStdDeviation11() {
        ...
        long[]      values = { 3, 4, 67, 23, 44, 56, 77, 1, 23, 44, 55 };
    ...
    public void testStdDeviation20() {
        ...
        long[]      values = { 1, 2, 4, 8, 16, 32, 64, 128, 256, //
