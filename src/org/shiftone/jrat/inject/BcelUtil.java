...
public class BcelUtil {
    ...
    private static final Log        LOG                        = LogFactory.getLogger(BcelUtil.class);
    private static final Comparator FIELD_OR_METHOD_COMPARATOR = new FieldOrMethodComparator();

    /**
     * This method computes the serialVersionUID of a BCEL JavaClass in the same way that the java.io.ObjectStreamClass class
     * computes it for a java.lang.Class.  This allows the ClassInjector to calculate this w/o actually loading the class.
     *
     * <p>
     ...
     *
     * <p>
     * Compute a hash for the specified class.  Incrementally add items to the hash accumulating in the digest stream.  Fold the
     * hash into a long.  Use the SHA secure hash function.
     * </p>
     *
     * @param javaClass .
     *
    ...
    /**
     * Class FieldOrMethodComparator
     *
     * @author <a href="mailto:jeff@shiftone.org">Jeff Drost</a>
     */
    static class FieldOrMethodComparator implements Comparator {
