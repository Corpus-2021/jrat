...
/**
 * Class NGraphPanel is a swing component that contains N graphs on top of each other,
 * each in a resizable pane, and a single scroll bar to move them back and forth.
 *
...
public class NGraphPanel extends JPanel
{
    ...
    private static final Log LOG                    = LogFactory.getLogger(NGraphPanel.class);
