...
public class XMLUtil {
    ...
    private static final Log LOG              = LogFactory.getLogger(XMLUtil.class);
     ...
     * @throws SAXException
     */
    public static XMLReader getXMLReaderFromParserFactory()
        throws SAXException {
     ...
     * @throws SAXException
     */
    public static XMLReader getXMLReaderFromReaderFactory()
        throws SAXException {
